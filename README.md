...
<b>Next Scheduled Release: 31st July 2023</b>
Due to the huge changes in CIS v2.0.0 I will try to release the improved version of the tool on the 31st of July. There will be a document with open-issues and things that need to be worked on for the release after that.
