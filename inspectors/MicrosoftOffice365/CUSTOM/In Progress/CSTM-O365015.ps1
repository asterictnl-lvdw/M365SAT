...
function Audit-CSTM-O365003
{
	...
	{
		# Actual Script,
		$Store = Invoke-MultiMicrosoftAPI -Url 'https://admin.microsoft.com/admin/api/settings/apps/store' -Resource "https://admin.microsoft.com" -Method 'GET'
		$StoreSettings = Invoke-MultiMicrosoftAPI -Url 'https://admin.microsoft.com/admin/api/storesettings/iwpurchasefeatureenabled' -Resource "https://admin.microsoft.com" -Method 'GET'
