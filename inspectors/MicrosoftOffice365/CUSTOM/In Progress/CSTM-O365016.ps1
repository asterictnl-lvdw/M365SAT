...
function Audit-CSTM-O365003
{
	...
	{
		# Actual Script,
		$SearchAdminAPI = Invoke-MultiMicrosoftAPI -Url 'https://admin.microsoft.com/admin/api/settings/security/guestUserPolicy' -Resource "https://admin.microsoft.com" -Method 'GET'
