...
function Audit-CSTM-O365003
{
	...
	{
		# Actual Script,
		$CalendarSharing = Invoke-MultiMicrosoftAPI -Url 'https://admin.microsoft.com/admin/api/settings/apps/calendarsharing' -Resource "https://admin.microsoft.com" -Method 'GET'
