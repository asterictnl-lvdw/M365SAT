...
function Audit-CSTM-O365003
{
	...
	{
		# Actual Script,
		$SearchAdminAPI = Invoke-MultiMicrosoftAPI -Url 'https://admin.microsoft.com/admin/api/services/apps/modernAuth' -Resource "https://admin.microsoft.com" -Method 'GET'
