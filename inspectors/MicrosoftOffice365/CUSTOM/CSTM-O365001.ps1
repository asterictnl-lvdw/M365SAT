...
# Purpose: Checks the Tenant License Level
...
function Build-CSTM-O365001($findings)
{
...
Function Audit-CSTM-O365001
{
	Try
	{
		...
		$endobject = Build-CSTM-O365001($org_licenses.Name)
		Return $endobject
	}
	catch
	{
