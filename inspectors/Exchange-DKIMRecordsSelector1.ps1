# This is an DKIMRecordsSelector1 Inspector.
...
function Build-DKIMRecordsSelector1($findings)
{
	#Actual Inspector Object that will be returned. All object values are required to be filled in.
	$inspectorobject = New-Object PSObject -Property @{
		ID			     = "M365SATFMEX0069"
		FindingName	     = "Domains with No DKIM Selector 1 DNS Record"
...
function Inspect-DKIMRecordsSelector1
{
	Try
	{
		...
		{
			$endobject = Build-DKIMRecordsSelector1($domains_without_records)
			Return $endobject 
		}
