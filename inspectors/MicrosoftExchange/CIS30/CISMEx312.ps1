...
{	
	Try
	{
		...
		Search-UnifiedAuditLog -StartDate $startDate -EndDate $endDate -RecordType AzureActiveDirectory -Operations "Add member to role." | Format-Table -AutoSize | Out-File "$path\CISMEx231AccountProvisioningActivityReport.txt"
