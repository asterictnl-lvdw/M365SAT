...
function Build-CISMSp7210($findings)
{
	...
	$inspectorobject = New-Object PSObject -Property @{
		...
		RiskRating	     = "High"
		Priority		 = "High"
		References	     = @(@{ 'Name' = 'Secure external sharing recipient experience'; 'URL' = 'https://learn.microsoft.com/en-US/sharepoint/what-s-new-in-sharing-in-targeted-release?WT.mc_id=365AdminCSH_spo' })
	}
