...
function Build-CISAz180($findings)
{
	#Actual Inspector Object that will be returned. All object values are required to be filled in.
	$inspectorobject = New-Object PSObject -Property @{
		ID			     = "CISAz180"
		FindingName	     = "CIS Az 1.8 - 'Notify users on password resets?' is set to 'No'"
...
function Audit-CISAz180
{
	try
	{
		...
		{
			$finalobject = Build-CISAz180($AffectedOptions)
			return $finalobject
		}
		return $null
	}
