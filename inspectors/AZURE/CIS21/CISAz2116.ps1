...
# Purpose: Ensure that Auto provisioning of 'Microsoft Defender for Containers components' is Set to 'On' (Automated)
...
function Build-CISAz2116($findings)
{
	...
	$inspectorobject = New-Object PSObject -Property @{
		...
		RiskRating	     = "Medium"
		Priority		 = "Medium"
		References	     = @(@{ 'Name' = 'Overview of Container security in Microsoft Defender for Containers'; 'URL' = 'https://learn.microsoft.com/en-us/azure/defender-for-cloud/monitoring-components?tabs=autoprovision-va' },
...
function Audit-CISAz2116
{
	try
	{
		...
		#$Settings = ((Invoke-AzRestMethod -Method GET -Path "/subscriptions/$($SubScriptionID.id)/providers/Microsoft.Security").content | ConvertFrom-Json | Select-Object properties)
		return $null
		#This does not have a valid script yet, and needs to be investigated
		<#
