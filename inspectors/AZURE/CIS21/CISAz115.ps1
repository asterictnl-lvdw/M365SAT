...
function Build-CISAz1150($findings)
{
	...
	$inspectorobject = New-Object PSObject -Property @{
		ID			     = "CISAz1150"
		FindingName	     = "CIS Az 1.15 - Guest invite restrictions is not set to 'Only users assigned to specific admin roles can invite guest users'"
...
function Audit-CISAz1150
{
	try
	{
		...
		{
			$finalobject = Build-CISAz1150($Policy.AllowInvitesFrom)
			return $finalobject
		}
		return $null
	}
