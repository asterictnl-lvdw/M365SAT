...
function Build-CISAz2118($findings)
{
	...
	$inspectorobject = New-Object PSObject -Property @{
		ID			     = "CISAz2118"
		FindingName	     = "CIS Az 2.1.18 - Additional email addresses is not Configured with any Security Contact Email"
		...
		ExpectedValue    = "An email address"
...
function Audit-CISAz2118
{
	try
	{
		...
		{
			$finalobject = Build-CISAz2118("No Emailaddresses specified")
			return $finalobject
		}
		return $null
	}
