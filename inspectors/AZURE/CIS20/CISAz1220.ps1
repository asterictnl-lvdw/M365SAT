...
function Build-CISAz1220($findings)
{
	...
	$inspectorobject = New-Object PSObject -Property @{
		ID			     = "CISAz1220"
		FindingName	     = "CIS Az 1.22 - Require Multi-Factor Authentication to register or join devices with Azure AD is set to No (0)"
...
function Audit-CISAz1220
{
	try
	{
		...
		{
			$finalobject = Build-CISAz1220("multiFactorAuthConfiguration: $($BetaSettingsObject.multiFactorAuthConfiguration)")
			return $finalobject
		}
		return $null
	}
