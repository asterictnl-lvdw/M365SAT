...
function Build-CISAz2014($findings)
{
	#Actual Inspector Object that will be returned. All object values are required to be filled in.
	$inspectorobject = New-Object PSObject -Property @{
		ID			     = "CISAz2014"
		FindingName	     = "CIS Az 2.14 - Users Can Register Applications Is Set to 'Yes'"
...
function Audit-CISAz2014
{
	try
	{
		...
		{
			$finalobject = Build-CISAz2014($Policy.DefaultUserRolePermissions.AllowedToCreateApps)
			return $finalobject
		}
		return $null
	}
