...
function Build-CISAz511($findings)
{
	...
	$inspectorobject = New-Object PSObject -Property @{
		ID			     = "CISAz511"
		FindingName	     = "CIS Az 5.1.1 - Setting: 'Auditing' on Azure SQL Servers is not set to 'On'"
		...
		RiskRating	     = "Low"
		Priority		 = "Low"
		References	     = @(@{ 'Name' = 'Remediate recommendations'; 'URL' = 'https://learn.microsoft.com/en-us/azure/defender-for-cloud/implement-security-recommendations' },
