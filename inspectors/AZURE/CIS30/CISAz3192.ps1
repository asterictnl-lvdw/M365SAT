...
function Audit-CISAz3132
{
	try
	{
		...
		$Settings = ((Invoke-AzRestMethod -Method GET -Path "/providers/Microsoft.ResourceGraph/resources?api-version=2021-03-01").Content | ConvertFrom-Json).properties.extensions | Where-Object {$_.name -eq ''}
