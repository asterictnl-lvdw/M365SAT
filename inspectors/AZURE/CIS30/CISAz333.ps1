...
function Build-CISAz333($findings)
{
	#Actual Inspector Object that will be returned. All object values are required to be filled in.
	$inspectorobject = New-Object PSObject -Property @{
		ID			     = "CISAz333"
		FindingName	     = "CIS Az 3.3.3 - Expiration Date is not set for all Secrets in RBAC Key Vaults"
...
function Audit-CISAz333
{
	try
	{
		...
		{
			$finalobject = Build-CISAz333($Violation)
			return $finalobject
		}
		return $null
	}
