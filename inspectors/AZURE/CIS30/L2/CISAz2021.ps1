...
function Build-CISAz2021($findings)
{
	#Actual Inspector Object that will be returned. All object values are required to be filled in.
	$inspectorobject = New-Object PSObject -Property @{
		ID			     = "CISAz2021"
		FindingName	     = "CIS Az 2.21 - Users can create Microsoft 365 groups in Azure portals, API or PowerShell"
...
function Audit-CISAz2021
{
	try
	{
		...
		{
			$finalobject = Build-CISAz2021("EnableGroupCreation: $($BetaSettingsObject.EnableGroupCreation)")
			return $finalobject
		}
		return $null
	}
