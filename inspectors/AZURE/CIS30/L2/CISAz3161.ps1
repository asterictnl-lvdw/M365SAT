...
function Build-CISAz3161($findings)
{
	#Actual Inspector Object that will be returned. All object values are required to be filled in.
	$inspectorobject = New-Object PSObject -Property @{
		ID			     = "CISAz3161"
		FindingName	     = "CIS Az 3.1.6.1 - Microsoft Defender for App Services Is Set to 'Off'"
		ProductFamily    = "Microsoft Azure"
		RiskScore	     = "2"
		Description	     = "Enabling Microsoft Defender for App Services allows for greater defense-in-depth, with threat detection provided by the Microsoft Security Response Center (MSRC)."
...
function Audit-CISAz3161
{
	try
	{
		...
		{
			$finalobject = Build-CISAz3161($AzSecuritySetting.PricingTier)
			return $finalobject
		}
		return $null
	}
