...
function Build-CISAz3141($findings)
{
	#Actual Inspector Object that will be returned. All object values are required to be filled in.
	$inspectorobject = New-Object PSObject -Property @{
		ID			     = "CISAz3141"
		FindingName	     = "CIS Az 3.1.4.1 - Microsoft Defender for Containers Is Set to 'Off'"
		ProductFamily    = "Microsoft Azure"
		RiskScore	     = "2"
		Description	     = "Enabling Microsoft Defender for Container Registries allows for greater defense-in-depth, with threat detection provided by the Microsoft Security Response Center (MSRC)."
		Remediation	     = "Use the PowerShell script to remediate the issue"
		PowerShellScript = 'Set-AzSecurityPricing -Name "Containers" -PricingTier "Standard"'
		DefaultValue	 = "Off"
		ExpectedValue    = "On"
...
function Audit-CISAz3141
{
	try
	{
		...
		{
			$finalobject = Build-CISAz3141($AzSecuritySetting.PricingTier)
			return $finalobject
		}
		return $null
	}
