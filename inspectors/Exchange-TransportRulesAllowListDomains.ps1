# This is an TransportRulesallowlistDomains Inspector.

# Date: 25-1-2023
# Version: 1.0
# Product Family: Microsoft Exchange
# Purpose: Checks if the Transport Rules have AllowList Domains
...
function Build-TransportRulesallowlistDomains($findings)
{
	#Actual Inspector Object that will be returned. All object values are required to be filled in.
	$inspectorobject = New-Object PSObject -Property @{
		ID			     = "M365SATFMEX0065"
		FindingName	     = "Email Security Checks are Bypassed Based on Sender Domain"
...
function Inspect-TransportRulesallowlistDomains
{
	Try
	{
		...
		$endobject = Build-TransportRulesallowlistDomains($domain_allowlist_rules)
		Return $endobject
