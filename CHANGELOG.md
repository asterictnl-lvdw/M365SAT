...
- There are issues with Windows PowerShell 7 where the latest ExchangeOnlineManagement module is not working together with the Az.Accounts module. I have added a workaround for not to keep the version of ExchangeOnlineManagement on 3.6.0 and use the 2.19.0 version of Az until issues have been fixed.